              ...
              <>
                {!isLoading &&
                  ...
                  todos.map((todo: Todo) => (
                    <li
                      key={todo._id}
                      className="bg-slate-900 p-6 rounded-lg my-2 hover:text-green-400 w-full text-lg flex justify-between"
                    >
                      ...
                      <div className="w-4/12 md:w-3/12">
                          <button className="text-sky-400 md:text-base text-sm px-2">Edit</button>
                          <button className="text-sky-400 md:text-base text-sm px-2">Del</button>
                      </div>
                    </li>
                  ))}
              </>
