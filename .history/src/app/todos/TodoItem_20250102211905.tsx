  ...
  return (
    <li className="bg-slate-900 p-6 rounded-lg my-2 hover:text-green-400 w-full text-lg flex justify-between items-start">
      ...
      <div className="w-8/12 md:w-3/12">
        <button onClick={() => onEdit(todo)} className="text-sky-400 md:text-base text-sm px-1">
        <i className="fas fa-pen text-sky-400"></i>
        </button>
        <button onClick={() => onDelete(todo._id)} className="text-pink-400 md:text-base text-sm px-2">
